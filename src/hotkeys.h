...
// Ctrl+Shift chord alternatives from the T/Y/U/G/H/J cluster, for keyboards
// with no nav cluster.
constexpr int kVkT = 0x54;  // recenter
...
constexpr int kChordLetters[] = { kVkT, kVkY, kVkG, kVkH };
